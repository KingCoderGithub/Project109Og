...
readingSTD2Start, readingSTD2End = readingMean-(2*readingSTD), readingMean+(2*readingSTD)
readingSTD3Start, readingSTD3End = readingMean-(3*readingSTD), readingMean+(3*readingSTD)
...
readingSTD2 = [result for result in readingScore if result > readingSTD2Start and result < readingSTD2End]
readingSTD3 = [result for result in readingScore if result > readingSTD3Start and result < readingSTD3End]
